...
public class OrderWorkFlowTest extends BaseTest {
    ...
    public OrderWorkFlowTest(String orderButton, String firstName, String lastName, String address, String subway, String  telephoneNumber,String date, int rentalPeriod, int colour, String comment) {
    ...
    public static Object[][] getOrderFormData() {
        return new Object[][]{
                // Короткий текст
                {"Кнопка заказа вверху страницы", "Имя", "Фио", "Бийск", "Сокольники", "83823315149", "25.11.2023" ,1, 0, "1"},
                // Длинный текст
                {"Кнопка заказа вверху страницы", "Имяимяим",
